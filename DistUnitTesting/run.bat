...
echo "Start server1 ..."
start "Server1 (%SERVER1%, %SERVER1_PARALLEL_DEGREE% cores)" %PROGRAM_SERVER% %SERVER1_PARALLEL_DEGREE% %SERVER1_PORT%
echo "Start server2 ..."
start "Server2 (%SERVER2%, %SERVER2_PARALLEL_DEGREE% cores)" %PROGRAM_SERVER% %SERVER2_PARALLEL_DEGREE% %SERVER2_PORT%

rem === start client
echo "Start client ..."
start "Client" %PROGRAM_CLIENT% %ASSEMBLY% %SERVER1% %SERVER2%